...
import { IconoHistorial, IconoHoy } from "@/components/paciente/iconos";

// En los formularios (nueva / editar) la barra se oculta: abajo va el botón Guardar.
const RUTAS_SIN_NAV = ["/paciente/nueva", "/paciente/comida/"];
    ...
    <>
      ...
      >
        <div className="mx-auto flex h-16 max-w-lg">
          <ItemNav href="/paciente" activo={pathname === "/paciente"} icono={<IconoHoy />}>
            Hoy
          </ItemNav>
          <ItemNav
            href="/paciente/historial"
            activo={pathname.startsWith("/paciente/historial")}
