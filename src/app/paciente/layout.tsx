...
import { NavInferior } from "@/components/paciente/nav-inferior";
...
export default async function LayoutPaciente({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh flex-1 flex-col bg-fondo text-tinta">
      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 pt-4">{children}</main>
